...
////purchaseテーブルにアクセスする PurchaseRepositoryを作成します
...
//
//public interface PurchaseReposiory extends JpaRepository<Purchase,Long> {
//	
//	
////	select文
////	@param フロントエンドから渡ってくるパラメーターであることを示している
//	
